# -*- coding: utf-8 -*-
"""
core — framework-agnostic modules shared across all page profiles.
...
from core.reel_sequence_engine import compile_sequence_reel, build_sequence_script_prompt
from core.page_profile import BasePageProfile
