...
class LegacyChannelAdapter(BaseChannelConfig):
    ...
    def display_name(self) -> str:
        from avatar_engine.persona_dna import ANNA_DISPLAY_NAME
    ...
    def get_visual_rules(self) -> dict[str, Any]:
        from avatar_engine.persona_dna import ENVIRONMENTS
    ...
    def get_ctas(self) -> list[str]:
        from avatar_engine.persona_dna import CTA_KEYWORDS
    ...
    def get_narrative_angles(self, mode: str = "") -> list[str]:
        from avatar_engine.persona_dna import NARRATIVE_ANGLES
    ...
    def get_rag_context(self, topic: str) -> str:
        ...
        try:
            ...
            from avatar_engine.knowledge.pdf_loader import (
