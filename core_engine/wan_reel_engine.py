...
def run_wan_reel_test(
    ...
    *,
    ...
    from core_engine.reel_sequence_engine import segment_script_into_act_snippets
    from core_engine.scene_pacing import describe_scene_plan, plan_scenes
    from avatar_engine.caption_engine import CaptionEngine

    started = datetime.now(timezone.utc)
    from core_engine.scene_pacing import parse_scene_duration
