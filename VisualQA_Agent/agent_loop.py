...
from VisualQA_Agent.image_generator import (
    compile_flux_prompt,
    generate_image,
    sanitize_prompt_for_flux,
)
from VisualQA_Agent.visual_critic import CriticVerdict, evaluate_image, list_reference_images
...
def build_base_prompt(
    ...
    try:
        from avatar_engine.visual_compiler import get_canonical_prompt
