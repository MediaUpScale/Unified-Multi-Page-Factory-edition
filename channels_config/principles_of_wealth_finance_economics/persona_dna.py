# -*- coding: utf-8 -*-
"""
Principles of Wealth persona — loaded from master_dna.json.

Avatar-OFF library-ingest page. Do NOT import this file directly —
use the root persona_dna module when ACTIVE_PAGE is set.
"""
...
ANNA_DISPLAY_NAME: str = _P.get("Subject", "Principles of Wealth")
...
ANNA_EXPERTISE_LENS: str = (
    ...
    "Independent educational analysis of wealth-creation frameworks."
)
...
BATCH_WORDS_PER_NARRATIVE: str = _BATCH.get("Words_Per_Narrative", "120-180")
...
def random_cta_keyword() -> str:
    return random.choice(CTA_KEYWORDS) if CTA_KEYWORDS else "PRINCIPLE"
...
def persona_context_block() -> str:
    ...
    return (
        f"Page: {ANNA_DISPLAY_NAME} (Principles of Wealth).\n"
...
def visual_style_block() -> str:
    ...
    return (
        "Avatar-OFF library ingest: existing production footage only.\n"
        f"Available environments: {'; '.join(n for n in env_names if n)}"
    )
