# -*- coding: utf-8 -*-
"""
Wonder Feed persona — loaded from channels_config/wonder_feed/master_dna.json.

Avatar-OFF page: no physical avatar, purely atmospheric imagery.
...
ANNA_DISPLAY_NAME: str = _P.get("Subject", "Wonder")
ANNA_AGE_YEARS: int = 0  # Avatar-OFF; no age rendered
...
ANNA_EXPERTISE_LENS: str = (
    ...
    "Translates attachment science and emotional psychology into warm, specific, "
...
BATCH_WORDS_PER_NARRATIVE: str = _BATCH.get("Words_Per_Narrative", "150-220")
...
ANNA_ACTIONS: list[str] = []  # No avatar actions
...
def random_cta_keyword() -> str:
    return random.choice(CTA_KEYWORDS) if CTA_KEYWORDS else "ANCHOR"
...
def persona_context_block() -> str:
    ...
    return (
        f"Page: {ANNA_DISPLAY_NAME} (Wonder Feed).\n"
...
def visual_style_block() -> str:
    ...
    return (
        "Avatar-OFF: no human subject. Purely atmospheric imagery.\n"
