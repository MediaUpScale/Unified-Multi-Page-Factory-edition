...
```
agents/posting/facebook_scheduler/
├── __init__.py
...
```bash
python agents/posting/facebook_scheduler/main.py --fill-times-only
```
...
```bash
python agents/posting/facebook_scheduler/main.py
```
...
```bash
python agents/posting/facebook_scheduler/main.py --background gradient_warm
```
...
```bash
python agents/posting/facebook_scheduler/main.py --record
# or directly:
python agents/posting/facebook_scheduler/record_mode.py
```
...
```bash
python agents/posting/facebook_scheduler/main.py --url https://www.facebook.com/MommaCircle
```
...
1. A full-page screenshot is saved to `agents/posting/facebook_scheduler/screenshots/`.
2. The error is logged to `agents/posting/facebook_scheduler/logs/fb_scheduler_YYYY-MM-DD.log`.
...
1. Run `python agents/posting/facebook_scheduler/main.py --record`.
...
```
python agents/posting/facebook_scheduler/main.py [OPTIONS]
