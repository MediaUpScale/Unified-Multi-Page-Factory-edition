# -*- coding: utf-8 -*-
"""
agents/posting/facebook_scheduler/main.py
============================
...
Override sheet or worksheet:
    python agents/posting/facebook_scheduler/main.py --sheet-id <ID> --worksheet MySheet
...
from agents.posting.facebook_scheduler.sheet import SheetQueue
...
def main(argv: "list[str] | None" = None) -> int:
    ...
    from agents.posting.facebook_scheduler.workflow_recorder import workflow_path as _default_wf_path
    ...
    if args.record:
        ...
        from agents.posting.facebook_scheduler.facebook_scheduler import (
            FacebookScheduler,
            attach_to_dolphin_profile,
        )
        from agents.posting.facebook_scheduler.workflow_recorder import run_recording_session
    ...
    # ------------------------------------------------------------------
    if args.show_bg:
        from agents.posting.facebook_scheduler.background_selector import list_presets
