# -*- coding: utf-8 -*-
"""
agents/posting/facebook_scheduler/record_mode.py
===================================
...
def launch_codegen(
    ...
    try:
        ...
        print("  - agents/posting/facebook_scheduler/facebook_scheduler.py  (SELECTORS section)")
        print("  - agents/posting/facebook_scheduler/background_selector.py (_BACKGROUNDS dict)")
