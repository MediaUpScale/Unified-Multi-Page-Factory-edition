...
Usage:
    from agents.posting.pinterest_engine.image_transformer import PinTransformer
...
class PinTransformer:
    ...
    def __init__(
        ...
        if outputs_dir is None:
            from agents.posting.pinterest_engine import config as _cfg  # noqa: PLC0415
    ...
    def _load_source(
        ...
        if video_path and Path(video_path).is_file():
            try:
                from agents.posting.pinterest_engine.inventory import extract_video_still  # noqa: PLC0415
...
if __name__ == "__main__":
    ...
    from agents.posting.pinterest_engine import config as cfg
