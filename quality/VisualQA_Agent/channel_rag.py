...
CHANNEL_DNA_SEED: dict[str, dict[str, Any]] = {
    ...
    "ancient_knowledge": {
        ...
        "forbidden_tokens": [
            ...
            # planner's forbidden-subject filter (agents.media.prompt_alignment
        ...
        "mandatory_elements": [
            # Relaxed critic bar: atmosphere over photoreal-geo checklists.
            "Atmospheric cinematic still of ancient ruins, artefacts, or structures",
            "Clean high-atmosphere FLUX renders are acceptable (film grain not required)",
            "Fantasy or surreal ancient-mystery interpretations are valid when the prompt allows them",
        ],
        "lighting_style": (
        ...
        "target_audience_rules": (
            ...
            "Accept clean FLUX atmosphere and fantasy ruins. "
            "Reject only severe anatomy, floating artifacts, or corrupt renders. "
            "Do not require a named real-world monument unless the prompt asked for one."
        ),
        "visual_concepts": {
        ...
        # ── motion_rules ────────────────────────────────────────────────
        # Consolidated from _MOTION_PROFILES in agents.media.animation_fx
        # + the parallax depth directive in agents.media.prompt_alignment.
        "motion_rules": {
            "motion_cadence": (
        ...
        # ── music_rules ─────────────────────────────────────────────────
        # Consolidated from agents.media/audio_engine.py music_prompt_directive
        ...
        "music_rules": {
            ...
            "mix_levels": (
                ...
                "(``_NARRATION_SPEED`` in agents.media/audio_engine.py). "
