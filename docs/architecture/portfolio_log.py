# -*- coding: utf-8 -*-
"""
Portfolio architecture log — filtered writer for docs/architecture/timeline.json.

This is NOT a pipeline hook. Do not call from QA retries, regenerate_scene,
or a routine ECONOMIC_REEL_LOFI run. Those events are too noisy for a
...
_TIMELINE = Path(__file__).resolve().parent / "timeline.json"
